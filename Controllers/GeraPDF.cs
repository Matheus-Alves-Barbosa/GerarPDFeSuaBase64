...
namespace GerarPDFeBase64.Controllers
{
    public static class GerarPDF
    {
        public static byte[] GeraPDF()
        {
            ...
            doc.Add(new Paragraph("PDF GERADO EM " + (DateTime.Now.AddHours(-3)).ToString("dd-MM-yyyy HH:mm:ss")).SetFontSize(15).SetBold().SetTextAlignment(iText.Layout.Properties.TextAlignment.CENTER));
